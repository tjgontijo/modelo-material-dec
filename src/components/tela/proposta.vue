      ...
      <q-card class="card-conteudo shadow-10">
          <q-card-section>
            <div class="box-shadow text-center">
              <span style="font-size: calc(1.5em + .7vw); font-weight: 500"><slot name="titulo_banner" /></span>
            </div>
          </q-card-section>
        <q-card-section>
          <div class="q-mx-md">
              <span style="font-size: calc(1.2em + .7vw); font-weight: 500" ><slot name="titulo_aula" /></span>
          </div>
        </q-card-section>
         <q-separator class="text-separator" inset spaced/>
        <q-card-section>
          <div class="q-mx-md">
            <p style="font-size: calc(1.2em + .5vw); font-weight: 500"><slot name="titulo_competencia" /></p>
            <ul class="recuo">
              <slot name="conteudo_competencia" />
            </ul>
          </div>
        </q-card-section>
        <q-card-section>
          <div class="q-mx-md">
            <p style="font-size: calc(1.2em + .5vw); font-weight: 500"><slot name="titulo_habilidade" /></p>
            <ul class="recuo">
              <slot name="conteudo_habilidade" />
            </ul>
          </div>
        </q-card-section>
        <q-card-section>
          <div class="q-mx-md final-pagina">
            <p style="font-size: calc(1.2em + .5vw); font-weight: 500"><slot name="titulo_atitude" /></p>
            <ul class="recuo">
              <slot name="conteudo_atitude" />
            </ul>
          </div>
        </q-card-section>
    </q-card>
